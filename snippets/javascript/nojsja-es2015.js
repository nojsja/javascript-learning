 ...
 * */
    ...
    nojsja["AjaxPool"] = (function() {
        ...
        //发送请求
        let sendRequest = function(method, url, data, callback){
        ...
        function observerInit(object) {
            ...
            object.trigger = function (type) {
                ...
                if(type){
                    ...
                    if(object.watcherList[type]){
                        for(let i = 0; i < object.watcherList[type].length; i++){
                    ...
                    for(let i = 0; i < object.watcherList._list.length; i++){
